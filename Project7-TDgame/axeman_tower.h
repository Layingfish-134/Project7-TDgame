...
public:
	AxemanTower()
	{
		...
		static std::vector<int> idx_list_idle_left = { 9, 10 };
		static std::vector<int> idx_list_idle_right = { 6, 7 };
		static std::vector<int> idx_list_fire_up = { 15, 16, 17 };
		static std::vector<int> idx_list_fire_down = { 12, 13, 14 };
		static std::vector<int> idx_list_fire_left = { 21, 22, 23 };
		static std::vector<int> idx_list_fire_right = { 18, 19, 20 };
