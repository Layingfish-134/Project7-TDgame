...
public:
	AxeBullet()
	{
		...
		static std::vector<int> idx_list = { 0,1,2,3,4,5,6,7 };
...
public:
	void on_collide(Enemy* enemy) override
	{
		...
		{
		case 0:
			Mix_PlayChannel(-1, sound_pool.find(ResID::Sound_AxeHit_1)->second, false);
			break;
		case 1:
			Mix_PlayChannel(-1, sound_pool.find(ResID::Sound_AxeHit_2)->second, false);
			break;
		case 2:
			Mix_PlayChannel(-1, sound_pool.find(ResID::Sound_AxeHit_3)->second, false);
			break;
		default:
			break;
		}
