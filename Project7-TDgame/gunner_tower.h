...
public:
	GunnerTower()
	{
		...
		static std::vector<int> idx_list_idle_up = { 4, 5 };
		static std::vector<int> idx_list_idle_down = { 0, 1 };
		static std::vector<int> idx_list_idle_left = { 12, 13 };
		static std::vector<int> idx_list_idle_right = { 8, 9 };
		static std::vector<int> idx_list_fire_up = { 20, 21, 22, 23 };
		static std::vector<int> idx_list_fire_down = { 16, 17, 18, 19 };
		static std::vector<int> idx_list_fire_left = { 28, 29, 30, 31 };
		static std::vector<int> idx_list_fire_right = { 24, 25, 26, 27 };
